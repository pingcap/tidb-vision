...
var IE_PROTO = __webpack_require__(198)('IE_PROTO');
...
var store = shared.store || (shared.store = new (__webpack_require__(339))());
...
if (__webpack_require__(11)) {
  ...
  var $buffer = __webpack_require__(204);
  var ctx = __webpack_require__(31);
  ...
  var arrayFill = __webpack_require__(182);
...
var defined = __webpack_require__(40);
var fails = __webpack_require__(5);
var spaces = __webpack_require__(202);
var space = '[' + spaces + ']';
var non = '\u200b\u0085';
...
module.exports = __webpack_require__(64) || !__webpack_require__(5)(function () {
  var K = Math.random();
...
var speciesConstructor = __webpack_require__(569);
...
var ctx = __webpack_require__(31);
var invoke = __webpack_require__(316);
...
var core = __webpack_require__(39);
var LIBRARY = __webpack_require__(64);
var wksExt = __webpack_require__(335);
...
var classof = __webpack_require__(102);
var from = __webpack_require__(308);
module.exports = function (NAME) {
...
var toLength = __webpack_require__(13);
var repeat = __webpack_require__(201);
var defined = __webpack_require__(40);
...
var _vue = __webpack_require__(297);

var _vue2 = _interopRequireDefault(_vue);

var _App = __webpack_require__(1384);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendor__ = __webpack_require__(305);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helper__ = __webpack_require__(563);
...
async function genStores() {
  ...
  let { status, data } = await __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__vendor__["axios"])({
    url: `${PDAPI}/trend`
  });
  ...
  const regionCList = __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].map(data.stores, 'all_count');
  const total = __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].sum(regionCList);
  var max = __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].max(regionCList);
  var min = __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].min(regionCList);
  ...
  let labels = data.stores.map((i, idx) => {
    ...
    return {
      ...
      label: `Store ${i.id} ${i.address}, with speed ${__WEBPACK_IMPORTED_MODULE_0__vendor__["_"].random(100, 900)}kbs`,
      id: 'store' + i.id,
      _id: i.id,
  ...
  let text = [];
  text = __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].map(labels, s => {
    const t = v => v > 0 ? '+' + v : '' + v;
  ...
  labels.forEach(s => {
    ...
    if (false) {} else {
      ...
      let idx = 0,
          fCount = 0,
          lCount = 0;
      __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].range(s.len).forEach(i => {
        __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].range(layerCount).forEach(x => {
          ++idx;
          let item = {
            block_id: s.id,
            start: i,
  ...
  // 动态根据 store 数量和
  let chords = __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].map(data.history.entries, i => {
    const pix = () => {
    ...
    const t = storeM[i.to];
    const w = pix();
    const start = __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].random(0, s.len * s.ratio - w);
    const start1 = t ? __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].random(0, t.len * t.ratio - w) : 2;
    return {
      type: i.kind,
      source: {
        id: 'store' + i.from,
  ...
  // write hist
  let hist = [];
  __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].forEach(labels, s => {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  async mounted() {
    const annoInstance = __WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].annotation();
    const annoSVG = __WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].select("svg.annotation-group").append("g").attr("class", "annotation-group");
    async function drawCircos(error) {
      ...
      var width = 980;
      if (!pdVisInstance) {
        pdVisInstance = new __WEBPACK_IMPORTED_MODULE_0__vendor__["Circos"]({
          container: '#circos-chart',
          width: width * 1.2,
          height: width * 1.2
        });

        var svgDefs = __WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].select('#circos-chart svg').append('defs');
        const c1 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__helper__["rgbToHex"])(__WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].interpolateGreens(0.1));
        const c2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__helper__["rgbToHex"])(__WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].interpolateGreens(0.5));
        var mainGradient = svgDefs.append('linearGradient').attr('id', 'mainGradient');
        // Create the stops of the main gradient. Each stop will be assigned
        // a class to style the stop using CSS.
        mainGradient.append('stop').attr('stop-color', c1).attr('offset', '0');
        mainGradient.append('stop').attr('stop-color', c2).attr('offset', '1');
      }
        ...
        events: {
          click: (d, i, nodes, e) => {
            const make = annoInstance.annotations([{
              type: __WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].annotationCalloutCircle,
              color: "#E8336D",
              note: {
            ...
            __WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].select("svg .annotation-group").call(make);

            return false;
            const p = nodes[i].parentElement.parentElement;
            const g = p.querySelectorAll('.stacks g')[i];
            const t = g.attributes.transform.value.slice(0, -1) + 'deg)'.replace('rotate(', 'rotate(-');
      ...
      pdVisInstance.stack('stacks', stacks, {
        innerRadius: 0.6,
        outerRadius: 0.98,
        logScale: false,
        // color: "YlOrRd",
        ...
        events: {
          'click': (d, i, nodes, e) => {
            ...
            __WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].select("svg").append("g").attr("class", "annotation-group").call(make);
          },
      ...
      setTimeout(() => {
        __WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].selectAll('.hotspot-blink').remove();
        hotSpots.forEach(s => {
          __WEBPACK_IMPORTED_MODULE_0__vendor__["_"].forEach(s.spots, i => {
            try {
              const tiles = document.querySelectorAll(`.stacks #block-${s.id} path.tile:not(.empty)`);
              tiles[__WEBPACK_IMPORTED_MODULE_0__vendor__["_"].random(0, tiles.length - 1)].appendChild(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__helper__["createHotpotEffect"])());
            } catch (e) {}
          });
        });
      }, 16);
    ...
    __WEBPACK_IMPORTED_MODULE_0__vendor__["d3"].select(document).on('visibilitychange', function () {
...
exports.createHotpotEffect = createHotpotEffect;
exports.sampleValFn = sampleValFn;
...
$export($export.P, 'Array', { fill: __webpack_require__(182) });
...
$export($export.P + $export.F * (__webpack_require__(103) != Object || !__webpack_require__(32)(arrayJoin)), 'Array', {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(21)(proto, TO_PRIMITIVE, __webpack_require__(571));
...
$export($export.S, 'Math', { fround: __webpack_require__(320) });
...
var $export = __webpack_require__(0);
var $parseFloat = __webpack_require__(329);
...
$export($export.S + $export.F * !__webpack_require__(11), 'Object', { defineProperties: __webpack_require__(324) });
...
var $export = __webpack_require__(0);
$export($export.S, 'Object', { is: __webpack_require__(574) });
...
$export($export.P, 'String', {
  ...
  repeat: __webpack_require__(201)
});
...
var fround = __webpack_require__(320);
...
$export($export.S, 'Math', { scale: __webpack_require__(322) });
...
var $export = __webpack_require__(0);
var ownKeys = __webpack_require__(328);
var toIObject = __webpack_require__(27);
var gOPD = __webpack_require__(25);
var createProperty = __webpack_require__(184);
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(0);
var $values = __webpack_require__(327)(false);
...
var toLength = __webpack_require__(13);
var isRegExp = __webpack_require__(132);
var getFlags = __webpack_require__(130);
...
__webpack_require__(191)($RegExpStringIterator, 'RegExp String', function next() {
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(0);
var $pad = __webpack_require__(333);
...
var $export = __webpack_require__(0);
var $task = __webpack_require__(203);
...
exports = module.exports = __webpack_require__(340)(undefined);
// imports


// module
exports.push([module.i, "#app{font-family:Helvetica,sans-serif;text-align:center}.chord.region{stroke-width:3;stroke-dasharray:500;stroke-dashoffset:500;-webkit-animation:dash 3s linear forwards;animation:dash 3s linear forwards;-webkit-animation-iteration-count:infinite;animation-iteration-count:infinite}.histogram1 .bin,.histogram .bin{-webkit-animation:tada 3s linear forwards;animation:tada 3s linear forwards;-webkit-animation-iteration-count:infinite;animation-iteration-count:infinite}@-webkit-keyframes tada{0%{-webkit-transform:scale(1);transform:scale(1)}10%,20%{-webkit-transform:scale(.99) rotate(-.2deg);transform:scale(.99) rotate(-.2deg)}30%,50%,70%,90%{-webkit-transform:scale(1.02) rotate(.2deg);transform:scale(1.02) rotate(.2deg)}40%,60%,80%{-webkit-transform:scale(1.02) rotate(-.2deg);transform:scale(1.02) rotate(-.2deg)}to{-webkit-transform:scale(1) rotate(0);transform:scale(1) rotate(0)}}@keyframes tada{0%{-webkit-transform:scale(1);transform:scale(1)}10%,20%{-webkit-transform:scale(.99) rotate(-.2deg);transform:scale(.99) rotate(-.2deg)}30%,50%,70%,90%{-webkit-transform:scale(1.02) rotate(.2deg);transform:scale(1.02) rotate(.2deg)}40%,60%,80%{-webkit-transform:scale(1.02) rotate(-.2deg);transform:scale(1.02) rotate(-.2deg)}to{-webkit-transform:scale(1) rotate(0);transform:scale(1) rotate(0)}}@-webkit-keyframes dash{to{stroke-dashoffset:0}}@keyframes dash{to{stroke-dashoffset:0}}@-webkit-keyframes slideInUp{0%{-webkit-transform:translate3d(-100%,0,0);transform:translate3d(-100%,0,0);visibility:visible}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@keyframes slideInUp{0%{-webkit-transform:translate3d(-100%,0,0);transform:translate3d(-100%,0,0);visibility:visible}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}.slideInUp{-webkit-animation-duration:1s;animation-duration:1s;-webkit-animation-fill-mode:both;animation-fill-mode:both;-webkit-animation-iteration-count:1;animation-iteration-count:1;-webkit-animation-name:slideInUp;animation-name:slideInUp}@-webkit-keyframes slideOutDown{0%{-webkit-transform:translateZ(0);transform:translateZ(0);opacity:1}to{visibility:hidden;opacity:0;-webkit-transform:translate3d(100%,0,0);transform:translate3d(100%,0,0)}}@keyframes slideOutDown{0%{-webkit-transform:translateZ(0);transform:translateZ(0);opacity:1}to{visibility:hidden;opacity:0;-webkit-transform:translate3d(100%,0,0);transform:translate3d(100%,0,0)}}.slideOutDown{-webkit-animation-duration:1s;animation-duration:1s;-webkit-animation-fill-mode:both;animation-fill-mode:both;-webkit-animation-iteration-count:1;animation-iteration-count:1;-webkit-animation-name:slideOutDown;animation-name:slideOutDown}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1459e3e0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(1386);
function injectStyle (ssrContext) {
  __webpack_require__(1387)
}
var normalizeComponent = __webpack_require__(1385)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1459e3e0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('div',{attrs:{"id":"circos-chart"}}),_vm._v(" "),_c('div',{staticClass:"info-container info-host"}),_vm._v(" "),_c('svg',{staticClass:"info-container info-legend"}),_vm._v(" "),_c('div',{staticClass:"info-container info-transfer"})])}
var staticRenderFns = []
...
var update = __webpack_require__(1388)("66b6b288", content, true);
...
var listToStyles = __webpack_require__(1389)
...
//# sourceMappingURL=index.js.map?3cf365a9435d54ea6e43